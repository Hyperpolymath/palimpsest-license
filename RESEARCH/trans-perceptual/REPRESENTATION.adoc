...
*Status:* FIRST PASS / RESEARCH *Purpose:* Licensing creative work that
exists beyond or across sensory modalities

'''''

=== The Frontier Problem

Some creative works exist in modes that traditional copyright—and
traditional perception—struggle to capture:
...
This document explores how Palimpsest might address creative works that
transcend or exist beyond human sensory categories.
...
A novel challenge: what does consent mean when the "`perceiver`" is not
human?
...
[arabic]
. *What makes a trans-perceptual work "`the same work`"?*
...
. *How do we handle perceiver variability?*
...
. *What does "`fair use`" mean for trans-perceptual works?*
* Sampling a scent for criticism?
* Describing an indescribable experience?
* Creating accessible versions?
. *How do we prevent trans-perceptual appropriation?*
...
. *What are the consent implications of brain-writing technology?*
...
. *How do we license for perceivers that don’t exist yet?*
...
[arabic]
. *Stimulus over experience:* License what can be specified
. *Modality agnosticism:* Don’t privilege any sensory channel
. *Translation acknowledgment:* Recognize inherent loss in translation
. *Perceiver diversity:* Account for variation in perception
. *Future extensibility:* Build for modalities we can’t imagine
. *Apophatic honesty:* Acknowledge what cannot be captured
. *Machine distinction:* Separate human and machine perception (for now)
. *Accessibility integration:* Include, don’t afterthink, accessibility
...
[arabic]
. *Community input:* Consult with synesthetes, accessibility advocates,
artists working in alternative modalities
. *Technical prototype:* Build metadata schema validator
. *Case study collection:* Document existing trans-perceptual works and
their licensing challenges
. *Philosophy consultation:* Engage philosophers of mind on qualia and
ownership
. *Future scanning:* Monitor neural interface and machine consciousness
research
