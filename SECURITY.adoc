...
The Palimpsest‑MPL License repository is maintained by the Palimpsest
Stewardship Council. +
...
Older tags remain available for historical reference but may not receive
fixes.
...
[arabic]
. Contact the Palimpsest Stewardship Council privately via the channels
listed in the repository README. +
. Include as much detail as possible (steps to reproduce, impact,
affected components). +
...
For more detailed information, see the documentation under `+docs/+` and
`+legal/+`.
