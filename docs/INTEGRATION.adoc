...
This guide covers integrating PMPL-1.0 (SPDX: PMPL-1.0-or-later) into
your development workflow, CI/CD pipelines, and compliance systems.
...
* *Documentation*:
https://github.com/hyperpolymath/palimpsest-license/docs
